...
const projectPopup = () => {
  ...
  confirm.addEventListener("click", () => {
    ...
    _add_project__WEBPACK_IMPORTED_MODULE_0__.projectList.forEach((proj) => {
    ...
    if (
      ...
      projectName.value == "one" ||
      projectName.value == "two" ||
      projectName.value == "three" ||
